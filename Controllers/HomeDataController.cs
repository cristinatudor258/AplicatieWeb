    ...
    public class HomeDataController : ControllerBase
    {
        ...
        public IActionResult GetTestul1()
        {
            try
            {
                ...
                var test = new List<IntrebariClass>();
                        ...
                        var intrebariUsoare = (from intrebare in _db.Intrebari where intrebare.IdTest==1 && intrebare.Dificultate == 0 && intrebare.Lungime== lungimeIntrebari select intrebare).Take(nrIntrebari);
                        var intrebariGrele = (from intrebare in _db.Intrebari where intrebare.IdTest == 1 && intrebare.Dificultate == 1 && intrebare.Lungime == lungimeIntrebari select intrebare).Take(nrIntrebari);
        ...
        public IActionResult GetTestul2()
        {
            try
            {
                ...
                var intrebariUsoare = (from intrebare in _db.Intrebari where intrebare.IdTest == 2 && intrebare.Dificultate == 0 && intrebare.Lungime == lungimeIntrebari select intrebare).Take(nrIntrebari);
                var intrebariGrele = (from intrebare in _db.Intrebari where intrebare.IdTest ==2 && intrebare.Dificultate == 1 && intrebare.Lungime == lungimeIntrebari select intrebare).Take(nrIntrebari);
                if (complexitateIntrebari == 0)
                {
                    test = intrebariUsoare.Union(intrebariGrele).Select(x => new IntrebariClass
                    {
        ...
        public IActionResult GetTestul3()
        {
            try
            {
                ...
                {
                    test = _db.Intrebari.Where(i=>i.IdTest==3 && i.Lungime==0).Select(x => new IntrebariClass
                    {
                        text = x.Intrebare,
                        responses = x.VarianteRaspuns,
                        raspunsCorect = x.RaspunsCorect,
                ...
                {
                    test = _db.Intrebari.Where(i => i.IdTest == 3 && i.Lungime == 1).Select(x => new IntrebariClass
                    {
                        text = x.Intrebare,
                        responses = x.VarianteRaspuns,
                        raspunsCorect = x.RaspunsCorect,
        ...
        public IActionResult GetTestul4()
        {
            try
            {
                ...
                if (lungimeIntrebari == 0)
                {
                    test = _db.Intrebari.Where(i => i.IdTest == 4 && i.Lungime == 0).Select(x => new IntrebariClass
                    {
                        text = x.Intrebare,
                        responses = x.VarianteRaspuns,
                        raspunsCorect = x.RaspunsCorect,
                ...
                {
                    test = _db.Intrebari.Where(i => i.IdTest == 4 && i.Lungime == 1).Select(x => new IntrebariClass
                    {
                        text = x.Intrebare,
                        responses = x.VarianteRaspuns,
                        raspunsCorect = x.RaspunsCorect,

...
namespace AplicatieWeb.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<AplicatieUtilizator> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                msg.AddContent(MimeType.Text, "Click pentru resetare parola: ");
                msg.AddContent(MimeType.Html, "<a href="+ callbackUrl + ">Click pentru resetare parola</a>");
